      ...
      <div className="w-full max-w-[390px] rounded-xl sm:rounded-2xl border border-white/20 bg-white/[0.13] backdrop-blur-xl shadow-2xl px-4 sm:px-6 py-5 sm:py-6">
        ...
        <form onSubmit={handleSubmit} className="mt-5 sm:mt-6 space-y-3">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full h-[48px] rounded-xl bg-slate-900 hover:bg-slate-800 font-bold text-sm shadow-xl shadow-slate-950/30 hover:scale-[1.01] transition disabled:opacity-60 flex items-center justify-center gap-3"
          >
